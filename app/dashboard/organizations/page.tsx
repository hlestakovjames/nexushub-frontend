        ...
        <div className="mx-auto max-w-7xl px-6 py-10 lg:px-8 lg:py-14">
          ...
          <div className="mt-10 rounded-2xl border border-slate-200 bg-white p-8">
            ...
            <h2 className="mt-3 text-2xl font-bold">
              No organization records loaded yet.
            </h2>

            <p className="mt-3 max-w-2xl leading-7 text-slate-600">
              The frontend workspace is ready. The organization
              listing, creation, editing, membership management,
              activation, and related operations will be connected
              to the Nexus Hub backend.
            </p>
          </div>
        </div>
      </section>
