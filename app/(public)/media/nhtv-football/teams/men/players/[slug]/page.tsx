...
const modules = [
  {
    ...
    title: 'Overview',
    description:
      'Player identity, profile information, and core Men’s football context.',
  },
  {
    number: '02',
    title: 'Statistics',
  ...
  },
  {
    ...
    title: 'Videos',
    description:
      'Interviews, highlights, features, analysis, and other visual coverage.',
  },
];

export default async function NHTVFootballMenPlayerProfilePage({
  params,
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-20 lg:px-8 lg:py-28">
          <div className="max-w-4xl">
            ...
            <p className="mt-8 text-sm font-semibold uppercase tracking-[0.2em] text-[#5FC9E6]">
              NHTV Football · Teams · Men · Player Profile
            </p>
            ...
            <p className="mt-6 max-w-3xl text-lg leading-8 text-white/70">
              An entity-level destination for a Men’s football player,
              connecting identity, team membership, matches, statistics,
              news, and videos.
            </p>
          </div>
        </div>
      ...
      <section className="bg-slate-50">
        <div className="mx-auto max-w-7xl px-6 py-20 lg:px-8 lg:py-28">
          <div className="rounded-3xl border border-slate-200 bg-white p-8 sm:p-10 lg:p-12">
            ...
            <h2 className="mt-3 text-3xl font-bold tracking-tight sm:text-4xl">
              Ready for structured Men’s football data.
            </h2>
            ...
            <p className="mt-5 max-w-3xl text-lg leading-8 text-slate-600">
              ...
              team membership, statistics, match participation, news, and
              videos.
            </p>
