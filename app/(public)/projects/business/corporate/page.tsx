  ...
  return (
    <>
      <ProjectSectionPage
        ...
        title="Corporate"
        intro="Structured corporate initiatives and organizational projects designed around defined objectives and deliverables."
        parentHref="/projects/business"
        parentLabel="Business Projects"
        areas={[]}
      />
