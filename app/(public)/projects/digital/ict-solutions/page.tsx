  ...
  return (
    <>
      <ProjectSectionPage
        ...
        title="ICT Solutions"
        intro="Practical ICT projects covering technical infrastructure, integrations, digital systems, and supporting technology services."
        parentHref="/projects/digital"
        parentLabel="Digital Projects"
        areas={[]}
      />
